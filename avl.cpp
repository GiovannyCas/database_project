...
//maintain the hieght and cnt field
...
AVLNode *avl_fix(AVLNode *node)
{
    while(true)
    {
        ...
        // continue to the parent node beacause its height may be changed
        node = parent;
    }
}
...
static AVLNode *avl_del_easy(AVLNode *node)
{
    ...
    //update the child parent pointer
    if (child)
    {
        child->parent = parent; // can be NULL
    }

    // attach the child's to the grandparent 
    if (!parent)
    {
